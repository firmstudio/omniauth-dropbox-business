# OmniAuth::DropboxBusiness

Welcome to your new gem! In this directory, you'll find the files you need to be able to package up your Ruby library into a gem. Put your Ruby code in the file `lib/omniauth/dropbox_business`. To experiment with that code, run `bin/console` for an interactive prompt.
...
Install the gem and add to the application's Gemfile by executing:
    ...
    $ bundle add omniauth_dropbox_business

If bundler is not being used to manage dependencies, install the gem by executing:

    $ gem install omniauth_dropbox_business
